...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Alunno}.
 */
@RestController
...
public class AlunnoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<AlunnoDTO>> getAllAlunnos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Alunnos");
        Page<AlunnoDTO> page = alunnoService.findAll(pageable);
